PlainGeometry.ApproveController = function () {
    ...
    Waypalm.defineEvents(this, PlainGeometry.ApproveController.Events);
    return this;
};
...
$(window).load(function () {
    ...
    controller.localChangesGroupingApplier['time'] = {
        ...
        nextList:function ($ul, $outer, item) {
            ...
            if ($ul == null || itemGroup !== this.lastGroup) {
                ...
                $ul = $(Waypalm.formatTemplate(this.listTemplate, {group:itemGroup, date:itemGroup})).appendTo($outer);
                $ul = $('ul', $ul);
            }
            return $ul;
        }
    ...
    controller.localChangesGroupingApplier['author'] = {
        ...
        nextList:function ($ul, $outer, item) {
            ...
            if ($ul == null || itemGroup !== this.lastGroup) {
                this.lastGroup = itemGroup;
                $ul = $(Waypalm.formatTemplate(this.listTemplate, {group:itemGroup, item:item})).appendTo($outer);
                $ul = $('ul', $ul);
            }
            return $ul;
        }
