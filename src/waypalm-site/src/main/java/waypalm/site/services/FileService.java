...
public interface FileService {
    String storeTile(Surface surface, TileImage tileImage, ImageValidator imageSelector) throws IOException;
    ...
    public static interface ImageValidator {
        boolean test(String fileFormat, ImageReader reader) throws IOException;
    }
}
